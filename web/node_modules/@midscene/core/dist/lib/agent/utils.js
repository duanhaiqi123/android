...
function matchElementFromPlan(planLocateParam) {
    ...
    if (planLocateParam.bbox) {
        ...
        const element = (0, extractor_namespaceObject.generateElementByPosition)(centerPosition, 'string' == typeof planLocateParam.prompt ? planLocateParam.prompt : planLocateParam.prompt?.prompt || '');
        return element;
    }
}
...
const getMidsceneVersion = ()=>"1.2.0";
