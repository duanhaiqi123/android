...
const actionScrollParamSchema = z.object({
    ...
    locate: getMidsceneLocationSchema().optional().describe('The target element to be scrolled on, like "the table" or "the list" or "the content area" or "the scrollable area"')
});
...
const actionAssertParamSchema = z.object({
    ...
    thought: z.string().describe('The thought of the assertion, like "I can see there are A, B, C elements on the page, which means ... , so the assertion is true"'),
